  ...
  return (
    <div
      ...
      style={{
        padding: '12px',
        borderRadius: '8px',
        cursor: mode === 'selectable' ? 'pointer' : undefined,
        backgroundColor:
          mode === 'selectable' && isHovered ? 'var(--primary-background-hover-color)' : undefined,
        transition: 'background-color 0.15s ease',
      }}
    >
      <Flex align="center" justify="space-between" gap="medium">
        <Flex direction="column" gap="xs" style={{ flex: '1 1 0', minWidth: 0 }}>
